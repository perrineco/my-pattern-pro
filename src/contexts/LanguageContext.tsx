...
const translations: Record<string, Record<Language, string>> = {
  ...
  'warn.noSeamAllowance': {
   ...
   'pdf.formatLabel': { en: 'Print format', fr: "Format d'impression" },
   'pdf.a4Sub': { en: 'Home printing', fr: 'Impression domestique' },
   'pdf.letterSub': { en: '216 × 279 mm', fr: '216 × 279 mm' },
   'pdf.a0Sub': { en: 'Plotter', fr: 'Traceur' },
   'pdf.projectionSub': { en: 'No assembly', fr: 'Sans assemblage' },
   'pdf.projectionTooltip': {
     en: 'Single-page format for retroprojection or digital cutting.\nOpen in a projection app (e.g. BenQ, Ishow) or cutting software.',
     fr: 'Format page unique pour rétroprojection ou découpe numérique.\nOuvrir dans un logiciel de projection (ex. BenQ, Ishow) ou de découpe.',
   },
  ...
  'profile.enterName': { en: 'Please enter a profile name', fr: 'Veuillez entrer un nom de profil' },
   ...
   'legend.referenceLines': { en: 'Reference lines', fr: 'Lignes de référence' },
   'legend.foldLine': { en: 'Fold line', fr: 'Ligne de pli' },
   'legend.dartLine': { en: 'Dart line', fr: 'Ligne de pince' },
   ...
   'piece.waist': { en: 'Waist', fr: 'Taille' },
   'piece.shoulder': { en: 'Shoulder', fr: 'Épaule' },
   'piece.armhole': { en: 'Armhole', fr: 'Emmanchure' },
   'piece.carrure': { en: 'Back width', fr: 'Carrure' },
   ...
   'misc.inDevelopment': { en: 'Under development', fr: 'En cours de développement' },
