...
const translations: Record<string, Record<Language, string>> = {
  ...
  'welcome.ctaDesc': { en: 'Join thousands of sewists drafting custom patterns with Petit Citron Studio.', fr: 'Rejoignez des milliers de couturiers qui créent des patrons sur mesure avec Petit Citron Studio.' },
