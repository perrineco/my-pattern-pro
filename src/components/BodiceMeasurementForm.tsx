...
export const defaultBodiceMeasurements: Record<Category, BodiceMeasurements> = {
  women: { bust: 92, neckCircumference: 36, shoulderLength: 13, backWidth: 36, backLength: 42 },
  men: { bust: 102, neckCircumference: 40, shoulderLength: 15, backWidth: 42, backLength: 46 },
  kids: { bust: 68, neckCircumference: 30, shoulderLength: 10, backWidth: 28, backLength: 30 },
};
