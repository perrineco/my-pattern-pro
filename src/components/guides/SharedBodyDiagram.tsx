...
function KidsBody() {
  return (
    <g id="kids">
      ...
      <path
        d="M 163.001 201.143
           C 163.513 201.894 165.416 208.013 165.416 208.013
           C 165.416 208.013 167.523 209.662 168.252 206.401
           C 168.982 203.141 167.591 201.843 167.591 201.843
           L 168.983 197.435
           C 168.983 197.435 168.991 201.964 170.392 202.295
           C 171.793 202.626 171.067 197.536 172.252 195.143
           C 172.915 193.803 172.52 191.675 171.657 190.004
           C 177.917 184.395 183.027 163.842 183.027 163.842
           C 189.238 157.157 191.112 151.06 192.001 142.303
           C 192.121 141.115 191.761 135.661 190.302 130.885
           C 188.867 126.181 186.333 122.146 186.454 122.001
           C 185.295 122.787 180.925 126.409 180.466 136.563
           C 174.198 147.823 173.579 158.167 173.579 158.167
           C 173.579 158.167 168.141 165.703 167.312 176.932
           C 167.208 178.331 166.879 183.538 165.874 188.622
           C 164.663 194.749 162.767 200.8 163.001 201.143
           Z"
        fill="url(#skinKids)"
        stroke="#9a6040"
        strokeWidth={1.2}
