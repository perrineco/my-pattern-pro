 ...
 function ArmDiagram({ category }: ArmDiagramProps) {
   ...
   return (
     ...
     >
       ...
       />
       <circle
         cx={centerX - armWidth / 2 - 25}
         cy={(shoulderY + wristY) / 2}
         r="10"
       ...
       />
       <circle
         cx={centerX + armWidth / 2 + 50}
         cy={(shoulderY + underarmY) / 2}
         r="10"
