  ...
  return (
    <Card className="p-4 space-y-4 bg-card border-border">
      ...
      <div className="space-y-4">
        ...
        <MeasurementInput label={t('meas.ease')} value={measurements.ease ?? 2} onChange={handleChange('ease')} hint={t('hint.addedWearingRoom')} tooltip={t('tooltip.ease')} min={0} max={8} step={0.5} unit={unit} />
